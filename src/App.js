...
import ListOfBatches from './Layouts/Admin Dashboard/Files/Batches/ListOfBatches';
import CreateBatch from './Layouts/Admin Dashboard/Files/Batches/CreateBatch';
import StudentAndTeacherBatchSelection from './Layouts/Admin Dashboard/Files/Batches/StudentAndTeacherBatchSelection';
import TeacherSelectionBatchCreation from './Layouts/Admin Dashboard/Files/Batches/TeacherSelectionBatchCreation';
import ProjectManagerSelectionBatchCreation from './Layouts/Admin Dashboard/Files/Batches/ProjectManagerSelectionBatchCreation';
import ViewBatch from './Layouts/Admin Dashboard/Files/Batches/ViewBatch';
import StudentListPayment from './Layouts/Admin Dashboard/Files/Payments/StudentListPayment';
    ...
    <Router>
        <Switch>
          ...
          <Route path="/abc" component={CheckingNavBar} />
           ...
           <AdminDashboardLayout path="/admin/list-of-batches/:id" component={ListOfBatches} />
           <AdminDashboardLayout path="/admin/student/create-batch/:id" component={CreateBatch} />
           <AdminDashboardLayout path="/admin/student/create-batch-student-selection/:id" component={StudentAndTeacherBatchSelection} />
           <AdminDashboardLayout path="/admin/student/create-batch-teacher-selection/:id" component={TeacherSelectionBatchCreation} />
           <AdminDashboardLayout path="/admin/student/create-batch-manager-selection/:id" component={ProjectManagerSelectionBatchCreation} />
           <AdminDashboardLayout path="/admin/view-batch/:id" component={ViewBatch} />
           <AdminDashboardLayout path="/admin/payments/:id" component={StudentListPayment} />
